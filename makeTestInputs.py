...
path = 'data_trajectories/Predicted_weather_phases'

#Need subtle changes to work for the Original, like 46 and such.

#path = 'ALLFT_weather_phases_dsc/Predicted_weather_phases'
...
with open(f'data_trajectories/Predicted-Split-{timesteps}.csv', 'a', encoding='UTF8', newline='') as f:
    writer = csv.writer(f)
    #header = ['ID','CI', 'PL']
    ...
    for subdir, dirs, files in os.walk(path):
        ...
        for file in files:
            ...
            flight_id = file_list[1].split(".")[0]

            #Make Subtle changes to work for Original ALLFT+
            if len(file_list)!=2:
                continue
